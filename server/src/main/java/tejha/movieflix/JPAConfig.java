...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("tejha.movieflix.entity");
	...
	private Properties jpaProperties() {
		...
		props.setProperty(PersistenceUnitProperties.DDL_GENERATION, PersistenceUnitProperties.CREATE_OR_EXTEND);//NONE);//
